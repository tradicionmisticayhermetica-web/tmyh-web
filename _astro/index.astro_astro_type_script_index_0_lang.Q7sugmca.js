import{i as h,C as w,E as y,p as b,e as $}from"./newsletter-cms.CrzAjGf6.js";import{f as A}from"./admin.WE6qEwXd.js";import{s as C}from"./supabase.2Xnj7Pbd.js";const s=document.getElementById("lista-campanas"),d=document.getElementById("buscador"),p=document.getElementById("contador"),r=document.getElementById("kpi-suscriptores");let n=[],i="todos",f="";function u(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function m(e){if(s){if(p&&(p.textContent=`${e.length} ${e.length===1?"campaña":"campañas"}`),e.length===0){s.innerHTML=`
          ...
          </div>`;return}s.innerHTML=e.map(t=>{const a=w[t.estado]??"text-parchment-400",v=y[t.estado]??t.estado,c=b(t),l=$(t),x=t.enviada_en??t.encolada_en??t.actualizada_en,g=["lista","enviando","pausada","enviada"].includes(t.estado);return`
          ...
          <div class="flex items-start justify-between gap-4 flex-wrap">
            <div class="flex-1 min-w-0">
              ...
              <div class="text-xs text-parchment-500 font-mono">
                ${t.total_destinatarios} destinatarios · ${t.enviados} enviados · ${t.fallidos+t.rebotados} con error
              </div>
              ${g?`
