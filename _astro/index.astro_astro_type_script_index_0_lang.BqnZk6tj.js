import{j as h,C as w,E as y,p as b,e as $}from"./newsletter-cms.BLbDBlqs.js";import{f as A}from"./admin.WE6qEwXd.js";import{s as C}from"./supabase.2Xnj7Pbd.js";const s=document.getElementById("lista-campanas"),d=document.getElementById("buscador"),p=document.getElementById("contador"),r=document.getElementById("kpi-suscriptores");let n=[],i="todos",f="";function u(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function m(e){if(s){if(p&&(p.textContent=`${e.length} ${e.length===1?"campaña":"campañas"}`),e.length===0){s.innerHTML=`
