import{k as h,C as b,E as w,p as $,e as y}from"./newsletter-cms.ekYa1ri2.js";import{f as A}from"./admin.Cw5UcnUQ.js";import{s as C}from"./supabase.TwzBJLgx.js";const s=document.getElementById("lista-campanas"),l=document.getElementById("buscador"),p=document.getElementById("contador"),r=document.getElementById("kpi-suscriptores");let n=[],i="todos",f="";function u(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}function m(e){if(s){if(p&&(p.textContent=`${e.length} ${e.length===1?"campaña":"campañas"}`),e.length===0){s.innerHTML=`
