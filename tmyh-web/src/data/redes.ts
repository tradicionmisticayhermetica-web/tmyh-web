 ...
 *
 * Nota: la cuenta de Instagram oficial de la escuela ES la cuenta personal
 * de Emanuel (`emanuelmari79`); no hay un perfil separado para "Tradicion
 * Mistica y Hermetica" en Instagram.
 */
export const REDES_OFICIALES: RedSocial[] = [
  {
    id: "instagram",
    nombre: "Instagram",
    url: "https://www.instagram.com/emanuelmari79/",
